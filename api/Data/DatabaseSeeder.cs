    ...
    public static class DatabaseSeeder
    {
        public static void Seed(ApplicationDbContext context)
        {
            ...
            var machines = new List<Machine>
            {
                ...
                new Machine { Name = "CNC Milling C1", Category = "Milling", SerialNumber = "MC001-2023", Status = MachineStatus.Running, InstallationDate = DateTime.UtcNow.AddMonths(-18), IsActive = true, TotalOperatingHours = 2890.4, LastStatusChangedAt = DateTime.UtcNow.AddHours(-8), ProductionLineId = lineA.Id, Icon = "fa-cogs", OrderInLine = 2, StaticProperties = "{\"NormTemp\": 65.0, \"BaseVib\": 3.5, \"NormPower\": 22.0}" },
                new Machine { Name = "Hydraulic Press P1", Category = "Pressing", SerialNumber = "PMC001-2023", Status = MachineStatus.Running, InstallationDate = DateTime.UtcNow.AddMonths(-5), IsActive = true, TotalOperatingHours = 540.0, LastStatusChangedAt = DateTime.UtcNow.AddHours(-17), ProductionLineId = lineA.Id, Icon = "fa-compress-alt", OrderInLine = 3, StaticProperties = "{\"NormTemp\": 55.0, \"BaseVib\": 5.0, \"NormPower\": 35.0}" },
                ...
                new Machine { Name = "Main Welding Robot W3", Category = "Welding", SerialNumber = "WR003-2023", Status = MachineStatus.Error, InstallationDate = DateTime.UtcNow.AddMonths(-12), IsActive = true, TotalOperatingHours = 1320.0, LastStatusChangedAt = DateTime.UtcNow.AddHours(-4), ProductionLineId = lineB.Id, Icon = "fa-fire", OrderInLine = 3, StaticProperties = "{\"NormTemp\": 130.0, \"BaseVib\": 2.0, \"NormPower\": 48.0}" },
                new Machine { Name = "Coating Station C2", Category = "Treatment", SerialNumber = "HT002-2023", Status = MachineStatus.Running, InstallationDate = DateTime.UtcNow.AddMonths(-4), IsActive = true, TotalOperatingHours = 410.0, LastStatusChangedAt = DateTime.UtcNow.AddHours(-6), ProductionLineId = lineB.Id, Icon = "fa-paint-roller", OrderInLine = 4, StaticProperties = "{\"NormTemp\": 85.0, \"BaseVib\": 1.0, \"NormPower\": 10.0}" },
                new Machine { Name = "QC Scanner Q2", Category = "Inspection", SerialNumber = "QC002-2023", Status = MachineStatus.Running, InstallationDate = DateTime.UtcNow.AddMonths(-11), IsActive = true, TotalOperatingHours = 1430.0, LastStatusChangedAt = DateTime.UtcNow.AddHours(-22), ProductionLineId = lineB.Id, Icon = "fa-search", OrderInLine = 5, StaticProperties = "{\"NormTemp\": 30.0, \"BaseVib\": 0.2, \"NormPower\": 2.5}" },
                
                // Other unassigned machines
                new Machine { Name = "Air Compressor AC1", Category = "Utility", SerialNumber = "AC001-2023", Status = MachineStatus.Running, InstallationDate = DateTime.UtcNow.AddYears(-2), IsActive = true, TotalOperatingHours = 5200.0, LastStatusChangedAt = DateTime.UtcNow.AddDays(-10), Icon = "fa-fan", StaticProperties = "{\"NormTemp\": 75.0, \"BaseVib\": 8.0, \"NormPower\": 60.0}" },
                new Machine { Name = "Chiller System CH1", Category = "Utility", SerialNumber = "CS001-2023", Status = MachineStatus.Running, InstallationDate = DateTime.UtcNow.AddYears(-3), IsActive = true, TotalOperatingHours = 6800.0, LastStatusChangedAt = DateTime.UtcNow.AddDays(-15), Icon = "fa-snowflake", StaticProperties = "{\"NormTemp\": 15.0, \"BaseVib\": 1.5, \"NormPower\": 85.0}" },
                new Machine { Name = "Pump System PS1", Category = "Utility", SerialNumber = "PS001-2023", Status = MachineStatus.Running, InstallationDate = DateTime.UtcNow.AddMonths(-15), IsActive = true, TotalOperatingHours = 1890.0, LastStatusChangedAt = DateTime.UtcNow.AddHours(-11), Icon = "fa-water", StaticProperties = "{\"NormTemp\": 50.0, \"BaseVib\": 4.5, \"NormPower\": 15.0}" }
            };
