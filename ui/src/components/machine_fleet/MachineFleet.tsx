...
import { MachineStatus, machineStatuses } from "../../types/machine";
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden">
            <Header
                leftContent={
                    <div>
                        <h1 className="text-xl font-bold text-slate-800">Machine Fleet Management</h1>
                        <p className="text-xs text-slate-500">Manage units, status, and alert thresholds</p>
                    </div>
                }
            ...
            <div className="flex-1 overflow-y-auto p-4 md:p-8 space-y-6 bg-slate-50">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3">
                    <div className="flex flex-col sm:flex-row gap-3 flex-1">
                        ...
                        {/* Status Filter */}
                        <SelectV2<MachineStatus | undefined>
                            value={statusFilter}
                            onChange={(val) => {
                                setStatusFilter(val);
                                setPage(1);
